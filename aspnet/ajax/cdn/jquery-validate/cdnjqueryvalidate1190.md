...
ms.locfileid: "54249588"
---
<a name="jquery-validation-1190"></a><span data-ttu-id="30f5a-102">Ověření 1.19.0 jQuery</span><span class="sxs-lookup"><span data-stu-id="30f5a-102">jQuery Validation 1.19.0</span></span>
====================
<span data-ttu-id="30f5a-103">Následující soubory jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="30f5a-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="30f5a-104">Lokalizace souborů na https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js kde ## je lokalizace kódu.</span><span class="sxs-lookup"><span data-stu-id="30f5a-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js where ## is the loc code.</span></span>
