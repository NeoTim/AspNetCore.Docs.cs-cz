...
U existujícího projektu, který vyžaduje HTTPS, použijte přesměrování HTTPS a HSTS middleware v `Startup.Configure`. Další informace naleznete v tématu <xref:security/enforcing-ssl>.
