...
Middleware předávaných hlaviček ( <xref:Microsoft.AspNetCore.HttpOverrides.ForwardedHeadersMiddleware> ) přečte tato záhlaví a vyplní v přidružených polích <xref:Microsoft.AspNetCore.Http.HttpContext> .
