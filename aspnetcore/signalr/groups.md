...
---
# <a name="manage-users-and-groups-in-no-locsignalr"></a>Správa uživatelů a skupin v nástrojiSignalR
...
## <a name="users-in-no-locsignalr"></a>Uživatelé vSignalR
...
## <a name="groups-in-no-locsignalr"></a>Skupiny vSignalR
