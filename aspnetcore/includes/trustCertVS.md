<span data-ttu-id="c0a3e-101">Visual Studio zobrazí následující dialog:</span><span class="sxs-lookup"><span data-stu-id="c0a3e-101">Visual Studio displays the following dialog:</span></span>
