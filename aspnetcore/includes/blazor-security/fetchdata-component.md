<span data-ttu-id="d145e-101">Tato `FetchData` součást ukazuje, jak:</span><span class="sxs-lookup"><span data-stu-id="d145e-101">The `FetchData` component shows how to:</span></span>
