...
---
# <a name="aspnet-core-21-razor-pages-samesite-cookie-sample"></a>Ukázka souborů Razor cookie SameSite 2,1 stránek ASP.NET Core
...
V předchozím kódu oba ověřování souborů cookie a stav relace nastaví jejich atribut sameSite na, `None`který vygeneruje atribut s `None` hodnotou a také nastaví zabezpečený atribut na. `true`
