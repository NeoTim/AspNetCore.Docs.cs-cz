...
Cookieověřování, stav relace a [různé další komponenty](https://docs.microsoft.com/aspnet/core/security/samesite?view=aspnetcore-3.0) nastavují své možnosti sameSite prostřednictvím Cookie možností, například
