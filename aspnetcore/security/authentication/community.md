...
| [IdentityServer](https://identityserver.io/) | IdentityServer je rozhraní OpenID Connect a OAuth 2,0 Framework pro ASP.NET Core oficiálně certifikováno OpenID Foundation a v rámci zásad správného řízení rozhraní .NET Foundation. Další informace najdete v tématu [Vítá vás Identity Server4 (dokumentace)](https://identityserver4.readthedocs.io/en/latest/). |
