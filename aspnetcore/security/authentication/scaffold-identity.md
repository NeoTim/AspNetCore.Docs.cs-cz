...
Tento dokument obsahuje podrobnější pokyny, než je soubor *ScaffoldingReadme. txt* , který je generován při spuštění nástroje pro generování uživatelského rozhraní.
