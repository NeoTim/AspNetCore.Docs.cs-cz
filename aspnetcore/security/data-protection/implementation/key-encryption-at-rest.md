...
---
# <a name="key-encryption-at-rest-in-windows-and-azure-using-aspnet-core"></a>Šifrování klíčů v klidovém formátu v systému Windows a Azure pomocí ASP.NET Core
