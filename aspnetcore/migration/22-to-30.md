...
V 3,0 je kompilace za běhu v případě výslovného souhlasu. Pokud chcete povolit kompilaci za běhu, přečtěte si téma <xref:mvc/views/view-compilation#runtime-compilation>.
