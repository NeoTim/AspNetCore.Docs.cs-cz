...
Tento článek vysvětluje, jak aktualizovat existující projekt ASP.NET Core 2.2 do ASP.NET Core 3.0. Mohlo by být užitečné vytvořit nový projekt ASP.NET Core 3.0 pro:

* Porovnejte s ASP.NET kód core 2.2.
* Zkopírujte příslušné změny v projektu ASP.NET Core 3.0.
