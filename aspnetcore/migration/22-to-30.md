...
Kromě povolení `AllowSynchronousIO` s možnostmi `ConfigureKestrel`je možné synchronní vstupně-výstupní operace přepsat na základě jednotlivých požadavků jako dočasné zmírnění:
