...
Visual Studio **automatického sestavení na žádost prohlížeče** prostředí nefunguje s [služby IIS v procesu model hostingu](xref:fundamentals/servers/aspnet-core-module#in-process-hosting-model). Při použití v rámci procesu hostování musí ručně znovu sestavit projekt. Mezi vylepšení tohoto prostředí jsou plánovány pro budoucí verze sady Visual Studio.
