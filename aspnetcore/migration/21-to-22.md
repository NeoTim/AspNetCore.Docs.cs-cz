...
Kód konfigurace doporučené protokolování nezměnil z 2.1 na verzi 2.2, ale některé vzorce kódování 1.x, které stále pracoval jsem s 2.1 už pracovat v 2.2.
