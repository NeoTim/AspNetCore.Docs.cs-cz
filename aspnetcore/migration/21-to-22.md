...
Pokud aplikace nevolá `CreateDefaultBuilder`, volání <xref:Microsoft.AspNetCore.Hosting.WebHostBuilderKestrelExtensions.UseKestrel*> **před** volání `ConfigureKestrel`:
...
* Přesunutí protokolování inicializace poskytovatele `Startup.ConfigureServices`.
...
* Filtrování použít změny <xref:Microsoft.Extensions.DependencyInjection.LoggingServiceCollectionExtensions.AddLogging*> Tvůrce.
...
* Změna konfigurace načítání určený `AddLogging` Tvůrce.
