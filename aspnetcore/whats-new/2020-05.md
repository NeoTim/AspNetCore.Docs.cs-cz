...
- <xref:blazor/webassembly-performance-best-practices>– Přidání dokumentu s osvědčenými postupy pro výkon Blazor WASM

## <a name="security"></a>Zabezpečení

### <a name="new-articles"></a>Nové články

- <xref:blazor/security/server/additional-scenarios>– Vytvořit uzel zabezpečení serveru Blazor
- <xref:blazor/security/server/index>– Vytvořit uzel zabezpečení serveru Blazor
- <xref:blazor/security/webassembly/aad-groups-roles>– Blazor WASM se skupinami AAD a rolemi
...
- <xref:blazor/security/webassembly/hosted-with-identity-server>– Přidejte oddíl pro konfiguraci deklarací identity a názvů pro Blazor se serverem identit.
