...
>
> Vytváření komponent v knihovně, která je možné sdílet s Blazor na straně klienta a Razor součásti aplikace na straně serveru, použijte knihovnu tříd Blazor vytvořené `blazorlib` šablony.
>
