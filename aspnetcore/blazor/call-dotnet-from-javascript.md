---
title: ' volání metod .NET z funkcí JavaScriptu ve ASP.NET Core Blazor ' Author: Description: ' Naučte se vyvolat metody .NET z funkcí JavaScriptu v Blazor aplikacích. '
