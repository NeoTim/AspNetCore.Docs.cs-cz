...
<span data-ttu-id="e3a4b-111">Existuje několik způsobů, jak může EF Core načíst související data do navigačních vlastností entity:</span><span class="sxs-lookup"><span data-stu-id="e3a4b-111">There are several ways that EF Core can load related data into the navigation properties of an entity:</span></span>
...
<span data-ttu-id="e3a4b-188">Tato část vygeneruje stránky instruktora a přidá související kurzy a registrace na stránku indexu instruktorů.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-188">This section scaffolds Instructor pages and adds related Courses and Enrollments to the Instructors Index page.</span></span>
...
<span data-ttu-id="e3a4b-205">Stránka instruktoři zobrazuje data ze tří různých tabulek.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-205">The instructors page shows data from three different tables.</span></span> <span data-ttu-id="e3a4b-206">Model zobrazení je potřeba, který obsahuje tři vlastnosti reprezentující tři tabulky.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-206">A view model is needed that includes three properties representing the three tables.</span></span>
...
<span data-ttu-id="e3a4b-226">Následující kód se spustí při výběru instruktora (`id != null`).</span><span class="sxs-lookup"><span data-stu-id="e3a4b-226">The following code executes when an instructor is selected (`id != null`).</span></span>
...
## <a name="next-steps"></a><span data-ttu-id="e3a4b-281">Další kroky</span><span class="sxs-lookup"><span data-stu-id="e3a4b-281">Next steps</span></span>
...
<span data-ttu-id="e3a4b-327">Chcete-li zobrazit název přiřazeného oddělení v seznamu kurzů:</span><span class="sxs-lookup"><span data-stu-id="e3a4b-327">To display the name of the assigned department in a list of courses:</span></span>
...
<span data-ttu-id="e3a4b-383">Stránka instruktoři zobrazuje data ze tří různých tabulek.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-383">The instructors page shows data from three different tables.</span></span> <span data-ttu-id="e3a4b-384">Vytvoří se model zobrazení, který obsahuje tři entity reprezentující tři tabulky.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-384">A view model is created that includes the three entities representing the three tables.</span></span>
...
<span data-ttu-id="e3a4b-418">Klikněte na odkaz **Vybrat** .</span><span class="sxs-lookup"><span data-stu-id="e3a4b-418">Click on the **Select** link.</span></span> <span data-ttu-id="e3a4b-419">Styl řádku se změní.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-419">The row style changes.</span></span>
...
<span data-ttu-id="e3a4b-442">Předchozí kód zobrazuje seznam kurzů souvisejících s instruktorem, když je vybrán instruktor.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-442">The preceding markup displays a list of courses related to an instructor when an instructor is selected.</span></span>

<span data-ttu-id="e3a4b-443">Otestujte aplikaci.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-443">Test the app.</span></span> <span data-ttu-id="e3a4b-444">Na stránce instruktoři klikněte na odkaz **Vybrat** .</span><span class="sxs-lookup"><span data-stu-id="e3a4b-444">Click on a **Select** link on the instructors page.</span></span>

### <a name="show-student-data"></a><span data-ttu-id="e3a4b-445">Zobrazit data studenta</span><span class="sxs-lookup"><span data-stu-id="e3a4b-445">Show student data</span></span>

<span data-ttu-id="e3a4b-446">V této části se aplikace aktualizuje, aby zobrazovala údaje o studentech pro vybraný kurz.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-446">In this section, the app is updated to show the student data for a selected course.</span></span>

<span data-ttu-id="e3a4b-447">Aktualizujte dotaz v `OnGetAsync` metodě na *stránkách/instruktorech/index. cshtml. cs* s následujícím kódem:</span><span class="sxs-lookup"><span data-stu-id="e3a4b-447">Update the query in the `OnGetAsync` method in *Pages/Instructors/Index.cshtml.cs* with the following code:</span></span>

[!code-csharp[](intro/samples/cu/Pages/Instructors/Index.cshtml.cs?name=snippet_ThenInclude&highlight=6-9)]

<span data-ttu-id="e3a4b-448">Aktualizovat *stránky/instruktory/index. cshtml*</span><span class="sxs-lookup"><span data-stu-id="e3a4b-448">Update *Pages/Instructors/Index.cshtml*.</span></span> <span data-ttu-id="e3a4b-449">Na konec souboru přidejte následující kód:</span><span class="sxs-lookup"><span data-stu-id="e3a4b-449">Add the following markup to the end of the file:</span></span>

[!code-html[](intro/samples/cu/Pages/Instructors/IndexRRD.cshtml?range=103-)]

<span data-ttu-id="e3a4b-450">Předchozí kód zobrazuje seznam studentů, kteří jsou zaregistrovaní ve vybraném kurzu.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-450">The preceding markup displays a list of the students who are enrolled in the selected course.</span></span>

<span data-ttu-id="e3a4b-451">Aktualizujte stránku a vyberte instruktora.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-451">Refresh the page and select an instructor.</span></span> <span data-ttu-id="e3a4b-452">Vyberte kurz, abyste zobrazili seznam zaregistrovaných studentů a jejich třídy.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-452">Select a course to see the list of enrolled students and their grades.</span></span>

![Stránka s indexem instruktorů a vybraným kurzem](read-related-data/_static/instructors-index.png)

## <a name="using-single"></a><span data-ttu-id="e3a4b-454">Použití jednoduchých</span><span class="sxs-lookup"><span data-stu-id="e3a4b-454">Using Single</span></span>

<span data-ttu-id="e3a4b-455">Metoda může `Where` předat`Where` podmínku namísto volání metody samostatně: `Single`</span><span class="sxs-lookup"><span data-stu-id="e3a4b-455">The `Single` method can pass in the `Where` condition instead of calling the `Where` method separately:</span></span>

[!code-csharp[](intro/samples/cu/Pages/Instructors/IndexSingle.cshtml.cs?name=snippet_single&highlight=21-22,30-31)]

<span data-ttu-id="e3a4b-456">Předchozí `Single` přístup neposkytuje oproti použití `Where`žádné výhody.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-456">The preceding `Single` approach provides no benefits over using `Where`.</span></span> <span data-ttu-id="e3a4b-457">Někteří vývojáři upřednostňují `Single` styl přístupu.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-457">Some developers prefer the `Single` approach style.</span></span>

## <a name="explicit-loading"></a><span data-ttu-id="e3a4b-458">explicitní načítání</span><span class="sxs-lookup"><span data-stu-id="e3a4b-458">Explicit loading</span></span>

<span data-ttu-id="e3a4b-459">Aktuální kód určuje Eager načítání pro `Enrollments` a: `Students`</span><span class="sxs-lookup"><span data-stu-id="e3a4b-459">The current code specifies eager loading for `Enrollments` and `Students`:</span></span>

[!code-csharp[](intro/samples/cu/Pages/Instructors/Index.cshtml.cs?name=snippet_ThenInclude&highlight=6-9)]

<span data-ttu-id="e3a4b-460">Předpokládejme, že uživatelé zřídka chtějí v kurzu zobrazit registrace.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-460">Suppose users rarely want to see enrollments in a course.</span></span> <span data-ttu-id="e3a4b-461">V takovém případě může optimalizace načíst data zápisu pouze v případě, že je požadováno.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-461">In that case, an optimization would be to only load the enrollment data if it's requested.</span></span> <span data-ttu-id="e3a4b-462">V této části `OnGetAsync` je aktualizována pro použití explicitního `Enrollments` načítání a `Students`.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-462">In this section, the `OnGetAsync` is updated to use explicit loading of `Enrollments` and `Students`.</span></span>

<span data-ttu-id="e3a4b-463">Aktualizujte `OnGetAsync` pomocí následujícího kódu:</span><span class="sxs-lookup"><span data-stu-id="e3a4b-463">Update the `OnGetAsync` with the following code:</span></span>

[!code-csharp[](intro/samples/cu/Pages/Instructors/IndexXp.cshtml.cs?name=snippet_OnGetAsync&highlight=9-13,29-35)]

<span data-ttu-id="e3a4b-464">Předchozí kód zruší volání metody *ThenInclude* pro údaje o registraci a studentovi.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-464">The preceding code drops the *ThenInclude* method calls for enrollment and student data.</span></span> <span data-ttu-id="e3a4b-465">Pokud je vybrán kurz, zvýrazněný kód načte:</span><span class="sxs-lookup"><span data-stu-id="e3a4b-465">If a course is selected, the highlighted code retrieves:</span></span>

* <span data-ttu-id="e3a4b-466">`Enrollment` Entity pro vybraný kurz.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-466">The `Enrollment` entities for the selected course.</span></span>
* <span data-ttu-id="e3a4b-467">Entity pro každou `Enrollment`. `Student`</span><span class="sxs-lookup"><span data-stu-id="e3a4b-467">The `Student` entities for each `Enrollment`.</span></span>

<span data-ttu-id="e3a4b-468">Všimněte si předcházejících komentářů `.AsNoTracking()`k kódu.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-468">Notice the preceding code comments out `.AsNoTracking()`.</span></span> <span data-ttu-id="e3a4b-469">Navigační vlastnosti lze explicitně načíst pouze pro sledované entity.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-469">Navigation properties can only be explicitly loaded for tracked entities.</span></span>

<span data-ttu-id="e3a4b-470">Otestujte aplikaci.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-470">Test the app.</span></span> <span data-ttu-id="e3a4b-471">V perspektivě uživatelů se aplikace chová stejně jako předchozí verze.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-471">From a users perspective, the app behaves identically to the previous version.</span></span>

<span data-ttu-id="e3a4b-472">V dalším kurzu se dozvíte, jak aktualizovat související data.</span><span class="sxs-lookup"><span data-stu-id="e3a4b-472">The next tutorial shows how to update related data.</span></span>

## <a name="additional-resources"></a><span data-ttu-id="e3a4b-473">Další zdroje</span><span class="sxs-lookup"><span data-stu-id="e3a4b-473">Additional resources</span></span>

* [<span data-ttu-id="e3a4b-474">Verze tohoto kurzu pro YouTube (part1)</span><span class="sxs-lookup"><span data-stu-id="e3a4b-474">YouTube version of this tutorial (part1)</span></span>](https://www.youtube.com/watch?v=PzKimUDmrvE)
* [<span data-ttu-id="e3a4b-475">Verze tohoto kurzu pro YouTube (Část2)</span><span class="sxs-lookup"><span data-stu-id="e3a4b-475">YouTube version of this tutorial (part2)</span></span>](https://www.youtube.com/watch?v=xvDDrIHv5ko)

>[!div class="step-by-step"]
><span data-ttu-id="e3a4b-476">[Předchozí](xref:data/ef-rp/complex-data-model)
>[Další](xref:data/ef-rp/update-related-data)</span><span class="sxs-lookup"><span data-stu-id="e3a4b-476">[Previous](xref:data/ef-rp/complex-data-model)
